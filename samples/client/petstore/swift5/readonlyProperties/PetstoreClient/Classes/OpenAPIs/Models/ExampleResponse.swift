...
public struct ExampleResponse: Codable, JSONEncodable, Hashable {
    ...
    public private(set) var emptyString: String? = ""
    public private(set) var numberString: String? = "42"
    public private(set) var boolString: String? = "false"
    public private(set) var nullString: String? = "null"
    public private(set) var aBool: Bool? = false
    public private(set) var zero: Int? = 0

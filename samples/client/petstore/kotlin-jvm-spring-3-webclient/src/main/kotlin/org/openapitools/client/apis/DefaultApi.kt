...
class DefaultApi(client: WebClient) : ApiClient(client) {
    ...
    fun retrieveSomething(): Mono<kotlin.collections.List<java.math.BigDecimal>> {
        return retrieveSomethingWithHttpInfo()
            .map { it.body }
    }

    @Throws(WebClientResponseException::class)
    fun retrieveSomethingWithHttpInfo(): Mono<ResponseEntity<kotlin.collections.List<java.math.BigDecimal>>> {

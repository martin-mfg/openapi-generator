...
ExampleResponse <- R6::R6Class(
  ...
  public = list(
    ...
    `aBool` = NULL,
    `zero` = NULL,
    `_field_list` = c("emptyString", "numberString", "boolString", "nullString", "aBool", "zero"),
    ...
    #' @export
    initialize = function(`emptyString` = "", `numberString` = "42", `boolString` = "false", `nullString` = "null", `aBool` = FALSE, `zero` = 0, additional_properties = NULL, ...) {

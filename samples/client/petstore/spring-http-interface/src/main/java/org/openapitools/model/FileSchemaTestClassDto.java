...
public class FileSchemaTestClassDto {
  ...
  */
  ...
  public FileSchemaTestClassDto files(java.util.List<FileDto> files) {
    this.files = files;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("files")
  public java.util.List<FileDto> getFiles() {
    return files;
  }

  public void setFiles(java.util.List<FileDto> files) {
    this.files = files;
  }

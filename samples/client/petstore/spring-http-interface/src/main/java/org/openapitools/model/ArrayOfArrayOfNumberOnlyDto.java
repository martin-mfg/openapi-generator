...
public class ArrayOfArrayOfNumberOnlyDto {
  ...
  public ArrayOfArrayOfNumberOnlyDto arrayArrayNumber(java.util.List<java.util.List<BigDecimal>> arrayArrayNumber) {
    this.arrayArrayNumber = arrayArrayNumber;
    return this;
  }

  public ArrayOfArrayOfNumberOnlyDto addArrayArrayNumberItem(java.util.List<BigDecimal> arrayArrayNumberItem) {

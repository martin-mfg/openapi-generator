...
class DefaultApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    suspend fun retrieveSomething() : kotlin.collections.List<java.math.BigDecimal> = withContext(Dispatchers.IO) {
    ...
    suspend fun retrieveSomethingWithHttpInfo() : ApiResponse<kotlin.collections.List<java.math.BigDecimal>?> = withContext(Dispatchers.IO) {
        val localVariableConfig = retrieveSomethingRequestConfig()

        return@withContext request<Unit, kotlin.collections.List<java.math.BigDecimal>>(
            localVariableConfig
        )
    }

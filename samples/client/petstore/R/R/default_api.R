...
#' @section Methods:
#' \describe{
#' \strong{ ExampleSomeMethodGet } \emph{  }
#' 
#'
#' \itemize{
...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    ExampleSomeMethodGet = function(data_file = NULL, ...) {
      local_var_response <- self$ExampleSomeMethodGetWithHttpInfo(data_file = data_file, ...)
    ...
    #' @export
    ExampleSomeMethodGetWithHttpInfo = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()

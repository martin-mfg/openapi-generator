## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `dummy`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the dummy API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Dummy                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | dummy                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | DummyConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | DummyRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Dummy.Client    | use the "dispatch" functions to send requests       |
| Dummy.Core      | core functions, config and request types            |
| Dummy.API       | construct api requests                              |
| Dummy.Model     | describes api models                                |
| Dummy.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Dummy.ModelLens | lenses for model fields                             |
| Dummy.Logging   | logging functions and utils                         |

...
data Mime = Mime deriving (P.Typeable)

-- | @/@
instance MimeType Mime where
  mimeType _ = Just $ P.fromString "/"
-- instance MimeRender Mime T.Text where mimeRender _ = undefined
-- instance MimeUnrender Mime T.Text where mimeUnrender _ = undefined

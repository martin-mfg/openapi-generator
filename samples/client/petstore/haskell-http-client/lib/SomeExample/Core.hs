...
-- |
data SomeExampleConfig = SomeExampleConfig
...
-- | display the config
instance P.Show SomeExampleConfig where
  show c =
    T.printf
...
-- | constructs a default SomeExampleConfig
--
-- configHost:
--
-- @http://localhost@
...
-- configUserAgent:
--
-- @"some-example/0.1.0.0"@
--
newConfig :: IO SomeExampleConfig
newConfig = do
    logCxt <- initLogContext
    return $ SomeExampleConfig
        { configHost = "http://localhost"
        , configUserAgent = "some-example/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => SomeExampleConfig -> auth -> SomeExampleConfig
addAuthMethod config@SomeExampleConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: SomeExampleConfig -> IO SomeExampleConfig
...
withStderrLogging :: SomeExampleConfig -> IO SomeExampleConfig
...
withNoLogging :: SomeExampleConfig -> SomeExampleConfig
...
data SomeExampleRequest req contentType res accept = SomeExampleRequest
  { rMethod  :: NH.Method   -- ^ Method of SomeExampleRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of SomeExampleRequest
  , rParams   :: Params -- ^ params of SomeExampleRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (SomeExampleRequest req contentType res accept) NH.Method
rMethodL f SomeExampleRequest{..} = (\rMethod -> SomeExampleRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (SomeExampleRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f SomeExampleRequest{..} = (\rUrlPath -> SomeExampleRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (SomeExampleRequest req contentType res accept) Params
rParamsL f SomeExampleRequest{..} = (\rParams -> SomeExampleRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (SomeExampleRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f SomeExampleRequest{..} = (\rAuthTypes -> SomeExampleRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => SomeExampleRequest req contentType res accept -> param -> SomeExampleRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: SomeExampleRequest req contentType res accept -> param -> SomeExampleRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: SomeExampleRequest req contentType res accept -> param -> SomeExampleRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** SomeExampleRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> SomeExampleRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = SomeExampleRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     SomeExampleRequest req contentType res accept
  -> [NH.Header]
  -> SomeExampleRequest req contentType res accept
...
removeHeader :: SomeExampleRequest req contentType res accept -> [NH.HeaderName] -> SomeExampleRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => SomeExampleRequest req contentType res accept -> SomeExampleRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => SomeExampleRequest req contentType res accept -> SomeExampleRequest req contentType res accept
...
addForm :: SomeExampleRequest req contentType res accept -> WH.Form -> SomeExampleRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: SomeExampleRequest req contentType res accept -> NH.Part -> SomeExampleRequest req contentType res accept
...
_setBodyBS :: SomeExampleRequest req contentType res accept -> B.ByteString -> SomeExampleRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: SomeExampleRequest req contentType res accept -> BL.ByteString -> SomeExampleRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => SomeExampleRequest req contentType res accept -> P.Proxy authMethod -> SomeExampleRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> SomeExampleRequest req contentType res accept
    -> IO (SomeExampleRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> SomeExampleConfig
  -> IO (SomeExampleRequest req contentType res accept)
_applyAuthMethods req config@(SomeExampleConfig {configAuthMethods = as}) =
  foldlM go req as
  where

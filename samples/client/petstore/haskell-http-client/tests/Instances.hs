...
genExampleResponse n =
  ExampleResponse
    <$> arbitraryReducedMaybe n -- exampleResponseEmptyString :: Maybe Text
    <*> arbitraryReducedMaybe n -- exampleResponseNumberString :: Maybe Text
    <*> arbitraryReducedMaybe n -- exampleResponseBoolString :: Maybe Text

...
private:
    ...
    void exampleSomeMethodGetCallback(PFXHttpRequestWorker *worker);

signals:

    void exampleSomeMethodGetSignal(PFXExampleResponse summary);

    void exampleSomeMethodGetSignalFull(PFXHttpRequestWorker *worker, PFXExampleResponse summary);

    void exampleSomeMethodGetSignalE(PFXExampleResponse summary, QNetworkReply::NetworkError error_type, QString error_str);

    void exampleSomeMethodGetSignalEFull(PFXHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);

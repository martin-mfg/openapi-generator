...
private:
    ...
    void retrieveSomethingCallback(PFXHttpRequestWorker *worker);

signals:

    void retrieveSomethingSignal(QList<double> summary);

    void retrieveSomethingSignalFull(PFXHttpRequestWorker *worker, QList<double> summary);

    void retrieveSomethingSignalE(QList<double> summary, QNetworkReply::NetworkError error_type, QString error_str);

...
public class DefaultApi {
     ...
     */
    public List<BigDecimal> retrieveSomething() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<BigDecimal>> retrieveSomethingWithHttpInfo() throws RestClientException {
        ...
        ParameterizedTypeReference<List<BigDecimal>> localReturnType = new ParameterizedTypeReference<List<BigDecimal>>() {};

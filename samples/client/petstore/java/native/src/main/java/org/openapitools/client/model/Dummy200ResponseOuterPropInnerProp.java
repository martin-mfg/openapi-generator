...
public class Dummy200ResponseOuterPropInnerProp {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `myBool` to the URL query string
    if (getMyBool() != null) {
      joiner.add(String.format("%smyBool%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMyBool()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

...
public class DefaultApi {
    ...
    */
    public void retrieveSomething(Handler<AsyncResult<List<BigDecimal>>> resultHandler) {
    ...
    * @param resultHandler Asynchronous result handler
    */
    public void retrieveSomething(ApiClient.AuthInfo authInfo, Handler<AsyncResult<List<BigDecimal>>> resultHandler) {
    ...
    */
    public Single<List<BigDecimal>> rxRetrieveSomething() {
    ...
    * @return Asynchronous result handler (RxJava Single)
    */
    public Single<List<BigDecimal>> rxRetrieveSomething(ApiClient.AuthInfo authInfo) {
        return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(fut ->

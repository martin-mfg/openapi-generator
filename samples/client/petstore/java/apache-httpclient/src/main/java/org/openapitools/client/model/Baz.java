...
public class Baz {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `innerBaz` to the URL query string
    if (getInnerBaz() != null) {
      try {
        joiner.add(String.format("%sinnerBaz%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getInnerBaz()), "UTF-8").replaceAll("\\+", "%20")));

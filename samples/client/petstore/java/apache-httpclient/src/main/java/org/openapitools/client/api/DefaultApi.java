...
public class DefaultApi {
  ...
  public ExampleResponse exampleSomeMethodGet() throws ApiException {
    return this.exampleSomeMethodGet(Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ExampleResponse exampleSomeMethodGet(Map<String, String> additionalHeaders) throws ApiException {

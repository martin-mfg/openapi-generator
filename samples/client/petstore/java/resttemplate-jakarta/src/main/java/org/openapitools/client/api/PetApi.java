...
public class PetApi {
     ...
     */
    @Deprecated
    public java.util.List<Pet> findPetsByTags(java.util.List<String> tags) throws RestClientException {
     ...
     */
    @Deprecated
    public ResponseEntity<java.util.List<Pet>> findPetsByTagsWithHttpInfo(java.util.List<String> tags) throws RestClientException {
        Object localVarPostBody = null;

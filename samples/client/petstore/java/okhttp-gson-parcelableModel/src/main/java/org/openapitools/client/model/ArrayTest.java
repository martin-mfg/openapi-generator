...
public class ArrayTest implements Parcelable {
  ...
  **/
  ...
  ArrayTest(Parcel in) {
    arrayOfString = (java.util.List<String>)in.readValue(null);
    arrayArrayOfInteger = (java.util.List<java.util.List<Long>>)in.readValue(java.util.List.class.getClassLoader());
    arrayArrayOfModel = (java.util.List<java.util.List<ReadOnlyFirst>>)in.readValue(java.util.List.class.getClassLoader());
  }

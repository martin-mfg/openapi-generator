...
public class XmlItem implements Parcelable {
  ...
  **/
  ...
  XmlItem(Parcel in) {
    ...
    wrappedArray = (java.util.List<Integer>)in.readValue(null);
    ...
    nameArray = (java.util.List<Integer>)in.readValue(null);
    nameWrappedArray = (java.util.List<Integer>)in.readValue(null);
    ...
    prefixArray = (java.util.List<Integer>)in.readValue(null);
    prefixWrappedArray = (java.util.List<Integer>)in.readValue(null);
    ...
    namespaceArray = (java.util.List<Integer>)in.readValue(null);
    namespaceWrappedArray = (java.util.List<Integer>)in.readValue(null);
    ...
    prefixNsArray = (java.util.List<Integer>)in.readValue(null);
    prefixNsWrappedArray = (java.util.List<Integer>)in.readValue(null);
  }

...
public class DefaultApi {
    ...
    private okhttp3.Call dummyCall(final ApiCallback _callback) throws ApiException {
    ...
    public class APIdummyRequest {

        private APIdummyRequest() {
        }
        ...
        /**
         * Execute dummy request (asynchronously)

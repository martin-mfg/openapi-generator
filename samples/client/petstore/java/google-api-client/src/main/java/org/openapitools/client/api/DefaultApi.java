...
public class DefaultApi {
  ...
  /**
    ...
    **/
    public List<BigDecimal> retrieveSomething() throws IOException {
        HttpResponse response = retrieveSomethingForHttpResponse();
        TypeReference<List<BigDecimal>> typeRef = new TypeReference<List<BigDecimal>>() {};
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public List<BigDecimal> retrieveSomething(Map<String, Object> params) throws IOException {

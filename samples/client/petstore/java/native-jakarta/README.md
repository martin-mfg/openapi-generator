...
```groovy
compile "org.openapitools:petstore-native-jakarta:dummy"
```
...
- `target/petstore-native-jakarta-dummy.jar`
- `target/lib/*.jar`
...
*DefaultApi* | [**dummyWithHttpInfo**](docs/DefaultApi.md#dummyWithHttpInfo) | **GET** /example/someMethod | 

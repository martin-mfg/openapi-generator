...
Protected Class DefaultApi
	#tag Method, Flags = &h0
		Function RetrieveSomething(ByRef localOutStatus As XojoOpenAPIClientSynchronous.XojoOpenAPIClientSynchronousException, localOutData() As Double) As Boolean
		  ...
		  Dim localVarPath As String = "/example/someMethod"
		  ...
		  Return RetrieveSomethingPrivateFuncDeserializeResponse(localVarHTTPStatus, localVarHeaders, localOutStatus, localVarContent, localOutData)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Function RetrieveSomethingPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As XojoOpenAPIClientSynchronous.XojoOpenAPIClientSynchronousException, Content As String, outData() As Double) As Boolean

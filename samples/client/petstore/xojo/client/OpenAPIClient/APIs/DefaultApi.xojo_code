...
Protected Class DefaultApi
	#tag Method, Flags = &h0
		Sub RetrieveSomething()
		  ...
		  // - 
		  //
		  // Invokes DefaultApiCallbackHandler.RetrieveSomethingCallback(Double) on completion. 
		  //
	...
	#tag Method, Flags = &h21
		Private Function RetrieveSomethingPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, outData() As Double) As Boolean

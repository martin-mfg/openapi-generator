...
api.exampleSomeMethodGet().then(function(data) {
...
------------ | ------------- | ------------- | -------------
*OpenapiJsClient.DefaultApi* | [**exampleSomeMethodGet**](docs/DefaultApi.md#exampleSomeMethodGet) | **GET** /example/someMethod | 

...
FHttpRequestPtr OpenAPIDefaultApi::Dummy(const DummyRequest& Request, const FDummyDelegate& Delegate /*= FDummyDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnDummyResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnDummyResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDummyDelegate Delegate) const
{

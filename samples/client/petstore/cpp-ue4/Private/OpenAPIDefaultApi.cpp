...
FHttpRequestPtr OpenAPIDefaultApi::ExampleSomeMethodGet(const ExampleSomeMethodGetRequest& Request, const FExampleSomeMethodGetDelegate& Delegate /*= FExampleSomeMethodGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnExampleSomeMethodGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnExampleSomeMethodGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FExampleSomeMethodGetDelegate Delegate) const
{
	ExampleSomeMethodGetResponse Response;

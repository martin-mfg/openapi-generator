...
FHttpRequestPtr OpenAPIDefaultApi::RetrieveSomething(const RetrieveSomethingRequest& Request, const FRetrieveSomethingDelegate& Delegate /*= FRetrieveSomethingDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnRetrieveSomethingResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnRetrieveSomethingResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FRetrieveSomethingDelegate Delegate) const
{
	RetrieveSomethingResponse Response;

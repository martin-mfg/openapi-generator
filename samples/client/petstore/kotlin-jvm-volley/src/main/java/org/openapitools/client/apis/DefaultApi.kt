...
class DefaultApi (
     ...
     */
    suspend fun retrieveSomething(): kotlin.collections.List<java.math.BigDecimal>? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<kotlin.collections.List<java.math.BigDecimal>> { response ->
            ...
            val responseType = object : TypeToken<kotlin.collections.List<java.math.BigDecimal>>() {}.type
            ...
            val request: Request<kotlin.collections.List<java.math.BigDecimal>> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,

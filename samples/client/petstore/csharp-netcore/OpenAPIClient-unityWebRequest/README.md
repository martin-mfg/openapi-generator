...
namespace Org.OpenAPIToolsExample
{
    ...
    public class ExampleSomeMethodGetExample : MonoBehaviour
    {
        async void Start()
        {
            ...
            try
            {
                ExampleResponse result = await apiInstance.ExampleSomeMethodGetAsync();
                Debug.Log(result);
                Debug.Log("Done!");
            }
            catch (ApiException e)
            {
                Debug.LogError("Exception when calling DefaultApi.ExampleSomeMethodGet: " + e.Message );
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**ExampleSomeMethodGet**](DefaultApi.md#examplesomemethodget) | **GET** /example/someMethod | 

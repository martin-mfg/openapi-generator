...
#' @section Methods:
#' \describe{
#' \strong{ example_some_method_get } \emph{  }
#' 
#'
#' \itemize{
...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    example_some_method_get = function(data_file = NULL, ...) {
      local_var_response <- self$example_some_method_get_with_http_info(data_file = data_file, ...)
    ...
    #' @export
    example_some_method_get_with_http_info = function(data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()

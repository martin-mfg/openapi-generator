# PSPetstore - the PowerShell module for the Some example
...
------------ | ------------- | ------------- | -------------
*PSDefaultApi* | [**Invoke-PSRetrieveSomething**](docs/PSDefaultApi.md#Invoke-PSRetrieveSomething) | **GET** /example/someMethod | 

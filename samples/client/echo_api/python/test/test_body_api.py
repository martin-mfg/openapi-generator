...
class TestBodyApi(unittest.TestCase):
    ...
    def test_test_body_application_octetstream_binary(self):
    ...
    def test_test_echo_body_free_form_object_response_string(self):
    ...
    def test_test_echo_body_pet_response_string(self):
    ...
    def test_test_echo_body_tag_response_string(self):

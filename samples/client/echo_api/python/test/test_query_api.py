...
class TestQueryApi(unittest.TestCase):
    ...
    def test_test_enum_ref_string(self):
    ...
    def test_test_query_datetime_date_string(self):
    ...
    def test_test_query_style_deep_object_explode_true_object(self):
    ...
    def test_test_query_style_deep_object_explode_true_object_all_of(self):
    ...
    def test_test_query_style_form_explode_true_object_all_of(self):

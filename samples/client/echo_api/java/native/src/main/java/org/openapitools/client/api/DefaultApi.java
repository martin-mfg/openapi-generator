...
public class DefaultApi {
  ...
  public List<BigDecimal> retrieveSomething() throws ApiException {
    ApiResponse<List<BigDecimal>> localVarResponse = retrieveSomethingWithHttpInfo();
  ...
  public ApiResponse<List<BigDecimal>> retrieveSomethingWithHttpInfo() throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<List<BigDecimal>>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<List<BigDecimal>>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {

...
> ApiResponse<List<BigDecimal>> retrieveSomething retrieveSomethingWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi(defaultClient);
        try {
            ApiResponse<List<BigDecimal>> response = apiInstance.retrieveSomethingWithHttpInfo();
...
ApiResponse<[**List&lt;BigDecimal&gt;**](BigDecimal.md)>

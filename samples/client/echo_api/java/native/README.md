...
```groovy
compile "org.openapitools:echo-api-native:1.0.0"
```
...
- `target/echo-api-native-1.0.0.jar`
- `target/lib/*.jar`
...
*DefaultApi* | [**exampleSomeMethodGetWithHttpInfo**](docs/DefaultApi.md#exampleSomeMethodGetWithHttpInfo) | **GET** /example/someMethod | 

...
public class FakeApi {
    ...
    public Response testEnumParameters(@HeaderParam("enum_header_string_array")   @ApiParam("Header parameter enum test (string array)") java.util.List<String> enumHeaderStringArray,@QueryParam("enum_query_string_array")  @ApiParam("Query parameter enum test (string array)")  java.util.List<String> enumQueryStringArray,@QueryParam("enum_query_string") @DefaultValue("-efg")  @ApiParam("Query parameter enum test (string)")  String enumQueryString,@QueryParam("enum_query_integer")  @ApiParam("Query parameter enum test (double)")  Integer enumQueryInteger,@QueryParam("enum_query_double")  @ApiParam("Query parameter enum test (double)")  Double enumQueryDouble,@FormParam(value = "enum_form_string_array")  java.util.List<String> enumFormStringArray,@FormParam(value = "enum_form_string")  String enumFormString) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response testInlineAdditionalProperties(@Valid @NotNull java.util.Map<String, String> param) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response testQueryParameterCollectionFormat(@QueryParam("pipe") @NotNull   java.util.List<String> pipe,@QueryParam("ioutil") @NotNull   java.util.List<String> ioutil,@QueryParam("http") @NotNull   java.util.List<String> http,@QueryParam("url") @NotNull   java.util.List<String> url,@QueryParam("context") @NotNull   java.util.List<String> context) {
        return Response.ok().entity("magic!").build();
    }

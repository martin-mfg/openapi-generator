...
public abstract class UserApiControllerImpInterface {
    ...
    public CompletionStage<Result> createUsersWithArrayInputHttp(Http.Request request, java.util.List<User> body) throws Exception {
        CompletableFuture<Result> result = CompletableFuture.supplyAsync(() -> {
        try {
    ...
    public abstract void createUsersWithArrayInput(Http.Request request, java.util.List<User> body) throws Exception;

    public CompletionStage<Result> createUsersWithListInputHttp(Http.Request request, java.util.List<User> body) throws Exception {
        CompletableFuture<Result> result = CompletableFuture.supplyAsync(() -> {
        try {
    ...
    public abstract void createUsersWithListInput(Http.Request request, java.util.List<User> body) throws Exception;

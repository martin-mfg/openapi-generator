...
public interface UserApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation") })
    public void createUsersWithArrayInput(@Valid @NotNull java.util.List<User> body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation") })
    public void createUsersWithListInput(@Valid @NotNull java.util.List<User> body);

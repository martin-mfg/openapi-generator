...
public abstract class UserApiControllerImpInterface {
    ...
    public Result createUsersWithArrayInputHttp(Http.Request request, java.util.List<User> body) throws Exception {
    ...
    public Result createUsersWithListInputHttp(Http.Request request, java.util.List<User> body) throws Exception {

...
public interface PetApi  {
    ...
    Future<ApiResponse<java.util.List<Pet>>> findPetsByStatus(java.util.List<String> status);
    Future<ApiResponse<java.util.List<Pet>>> findPetsByTags(java.util.List<String> tags);

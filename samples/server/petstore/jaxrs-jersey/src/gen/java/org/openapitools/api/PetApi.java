...
public class PetApi  {
   ...
   public PetApi(@Context ServletConfig servletContext) {
    ...
    public Response findPetsByStatus(@ApiParam(value = "Status values that need to be considered for filter", required = true) @QueryParam("status") @NotNull @Valid  java.util.List<String> status,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response findPetsByTags(@ApiParam(value = "Tags to filter by", required = true) @QueryParam("tags") @NotNull @Valid  java.util.Set<String> tags,@Context SecurityContext securityContext)
    throws NotFoundException {

...
public class FakeApi  {
 ...
 @FormDataParam("binary") FormDataBodyPart binaryBodypart ,@ApiParam(value = "None")  @FormParam("date")  Date date,@ApiParam(value = "None")  @FormParam("dateTime")  java.util.Date dateTime,@ApiParam(value = "None")  @FormParam("password")  String password,@ApiParam(value = "None")  @FormParam("callback")  String paramCallback,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testInlineAdditionalProperties(@ApiParam(value = "request body", required = true) @NotNull @Valid  java.util.Map<String, String> requestBody,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testQueryParameterCollectionFormat(@ApiParam(value = "", required = true) @QueryParam("pipe") @NotNull @Valid  java.util.List<String> pipe,@ApiParam(value = "", required = true) @QueryParam("ioutil") @NotNull @Valid  java.util.List<String> ioutil,@ApiParam(value = "", required = true) @QueryParam("http") @NotNull @Valid  java.util.List<String> http,@ApiParam(value = "", required = true) @QueryParam("url") @NotNull @Valid  java.util.List<String> url,@ApiParam(value = "", required = true) @QueryParam("context") @NotNull @Valid  java.util.List<String> context,@ApiParam(value = "", required = true) @QueryParam("allowEmpty") @NotNull  String allowEmpty,@ApiParam(value = "") @QueryParam("language") @Valid  java.util.Map<String, String> language,@Context SecurityContext securityContext)
    throws NotFoundException {

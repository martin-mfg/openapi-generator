...
public class UserApi  {
   ...
   public UserApi(@Context ServletConfig servletContext) {
    ...
    public Response createUsersWithArrayInput(@ApiParam(value = "List of user object", required = true) @NotNull @Valid  java.util.List<User> user,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response createUsersWithListInput(@ApiParam(value = "List of user object", required = true) @NotNull @Valid  java.util.List<User> user,@Context SecurityContext securityContext)
    throws NotFoundException {

...
public abstract class FakeApiService {
    ...
    public abstract Response testInlineAdditionalProperties(java.util.Map<String, String> requestBody,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response testQueryParameterCollectionFormat( @NotNull java.util.List<String> pipe, @NotNull java.util.List<String> ioutil, @NotNull java.util.List<String> http, @NotNull java.util.List<String> url, @NotNull java.util.List<String> context, @NotNull String allowEmpty,java.util.Map<String, String> language,SecurityContext securityContext) throws NotFoundException;

...
public abstract class UserApiService {
    ...
    public abstract Response createUsersWithArrayInput(java.util.List<User> user,SecurityContext securityContext) throws NotFoundException;
    public abstract Response createUsersWithListInput(java.util.List<User> user,SecurityContext securityContext) throws NotFoundException;

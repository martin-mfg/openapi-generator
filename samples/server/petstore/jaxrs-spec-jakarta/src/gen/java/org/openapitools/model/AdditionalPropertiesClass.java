...
public class AdditionalPropertiesClass  implements Serializable {
  ...
  public static abstract class AdditionalPropertiesClassBuilder<C extends AdditionalPropertiesClass, B extends AdditionalPropertiesClassBuilder<C, B>>  {
    ...
    public B mapString(java.util.Map<String, String> mapString) {
      this.mapString = mapString;
      return self();
    }
    public B mapNumber(java.util.Map<String, BigDecimal> mapNumber) {
      this.mapNumber = mapNumber;
      return self();
    }
    public B mapInteger(java.util.Map<String, Integer> mapInteger) {
      this.mapInteger = mapInteger;
      return self();
    }
    public B mapBoolean(java.util.Map<String, Boolean> mapBoolean) {
      this.mapBoolean = mapBoolean;
      return self();
    }
    public B mapArrayInteger(java.util.Map<String, java.util.List<Integer>> mapArrayInteger) {
      this.mapArrayInteger = mapArrayInteger;
      return self();
    }
    public B mapArrayAnytype(java.util.Map<String, java.util.List<Object>> mapArrayAnytype) {
      this.mapArrayAnytype = mapArrayAnytype;
      return self();
    }
    public B mapMapString(java.util.Map<String, java.util.Map<String, String>> mapMapString) {
      this.mapMapString = mapMapString;
      return self();
    }
    public B mapMapAnytype(java.util.Map<String, java.util.Map<String, Object>> mapMapAnytype) {
      this.mapMapAnytype = mapMapAnytype;
      return self();
    }

...
public class XmlItem  implements Serializable {
  ...
  public static abstract class XmlItemBuilder<C extends XmlItem, B extends XmlItemBuilder<C, B>>  {
    ...
    public B wrappedArray(java.util.List<Integer> wrappedArray) {
      this.wrappedArray = wrappedArray;
      return self();
    }
    ...
    public B nameArray(java.util.List<Integer> nameArray) {
      this.nameArray = nameArray;
      return self();
    }
    public B nameWrappedArray(java.util.List<Integer> nameWrappedArray) {
      this.nameWrappedArray = nameWrappedArray;
      return self();
    }
    ...
    public B prefixArray(java.util.List<Integer> prefixArray) {
      this.prefixArray = prefixArray;
      return self();
    }
    public B prefixWrappedArray(java.util.List<Integer> prefixWrappedArray) {
      this.prefixWrappedArray = prefixWrappedArray;
      return self();
    }
    ...
    public B namespaceArray(java.util.List<Integer> namespaceArray) {
      this.namespaceArray = namespaceArray;
      return self();
    }
    public B namespaceWrappedArray(java.util.List<Integer> namespaceWrappedArray) {
      this.namespaceWrappedArray = namespaceWrappedArray;
      return self();
    }
    ...
    public B prefixNsArray(java.util.List<Integer> prefixNsArray) {
      this.prefixNsArray = prefixNsArray;
      return self();
    }
    public B prefixNsWrappedArray(java.util.List<Integer> prefixNsWrappedArray) {
      this.prefixNsWrappedArray = prefixNsWrappedArray;
      return self();
    }
  }

...
public class PetApi  {
   ...
   public PetApi(@Context ServletConfig servletContext) {
    ...
    @io.swagger.annotations.ApiResponses(value = {
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = List.class, responseContainer = "List"),
    ...
    @io.swagger.annotations.ApiResponses(value = {
        @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Set.class, responseContainer = "Set"),

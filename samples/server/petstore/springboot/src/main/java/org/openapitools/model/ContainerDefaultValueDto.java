...
public class ContainerDefaultValueDto {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link ContainerDefaultValueDto#ContainerDefaultValueDto(java.util.List<String>, java.util.List<String>)}
   */
  @Deprecated
   ...
   */
  public ContainerDefaultValueDto(java.util.List<String> nullableRequiredArray, java.util.List<String> requiredArray) {
    this.nullableRequiredArray = JsonNullable.of(nullableRequiredArray);
    this.requiredArray = requiredArray;
  }

  public ContainerDefaultValueDto nullableArray(java.util.List<String> nullableArray) {
  ...
  */
  ...
  public ContainerDefaultValueDto nullableRequiredArray(java.util.List<String> nullableRequiredArray) {
    this.nullableRequiredArray = JsonNullable.of(nullableRequiredArray);
    return this;
  }
  ...
  */
  ...
  public ContainerDefaultValueDto requiredArray(java.util.List<String> requiredArray) {
    this.requiredArray = requiredArray;
    return this;
  }
  ...
  */
  ...
  public ContainerDefaultValueDto nullableArrayWithDefault(java.util.List<String> nullableArrayWithDefault) {

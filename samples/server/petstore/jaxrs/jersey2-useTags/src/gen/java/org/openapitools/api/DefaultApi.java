...
public class DefaultApi  {
   ...
   public DefaultApi(@Context ServletConfig servletContext) {
    ...
    @io.swagger.annotations.ApiOperation(value = "", notes = "get some object", response = BigDecimal.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = {
        @io.swagger.annotations.ApiResponse(code = 200, message = "The response with results", response = BigDecimal.class, responseContainer = "List")
    })

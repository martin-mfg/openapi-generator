...
public abstract class PetApiService {
    ...
    public abstract Response findPetsByStatus( @NotNull java.util.List<String> status,SecurityContext securityContext) throws NotFoundException;
    public abstract Response findPetsByTags( @NotNull java.util.Set<String> tags,SecurityContext securityContext) throws NotFoundException;

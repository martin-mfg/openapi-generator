...
void ExampleResponse::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("myOnlyProperty")) {
        m_MyOnlyProperty = fromPt<std::set<double>>(pt.get_child("myOnlyProperty"));
	}
}

std::set<double> ExampleResponse::getMyOnlyProperty() const
{
    return m_MyOnlyProperty;
}

void ExampleResponse::setMyOnlyProperty(std::set<double> value)
{

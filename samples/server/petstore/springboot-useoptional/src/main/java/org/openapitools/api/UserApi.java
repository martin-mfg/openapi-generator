...
public interface UserApi {
    ...
    default ResponseEntity<List<Param1Def>> createUsersWithArrayInput(
        @ApiParam(value = "") @RequestHeader(value = "param0", required = false) Optional<Param0Def> param0,
        @ApiParam(value = "") @RequestHeader(value = "param1", required = false) Optional<List<@Valid Param1Def>> param1
    ) {

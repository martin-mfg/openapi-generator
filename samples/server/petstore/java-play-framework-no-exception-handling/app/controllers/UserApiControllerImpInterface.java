...
public abstract class UserApiControllerImpInterface {
    ...
    public Result createUsersWithArrayInputHttp(Http.Request request, java.util.List<User> body)  {
        createUsersWithArrayInput(request, body);
        return ok();

    }

    public abstract void createUsersWithArrayInput(Http.Request request, java.util.List<User> body) ;

    public Result createUsersWithListInputHttp(Http.Request request, java.util.List<User> body)  {
        createUsersWithListInput(request, body);
        return ok();

    }

    public abstract void createUsersWithListInput(Http.Request request, java.util.List<User> body) ;

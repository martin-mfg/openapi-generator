...
public abstract class PetApiControllerImpInterface {
    ...
    public Result findPetsByStatusHttp(Http.Request request, @NotNull java.util.List<String> status)  {
        if (!securityAPIUtils.isRequestTokenValid(request, "petstore_auth")) {
            return unauthorized();
        }
    ...
    public abstract array<java.util.List<Pet>> findPetsByStatus(Http.Request request, @NotNull java.util.List<String> status) ;

    public Result findPetsByTagsHttp(Http.Request request, @NotNull java.util.List<String> tags)  {
        if (!securityAPIUtils.isRequestTokenValid(request, "petstore_auth")) {
            return unauthorized();
        }
    ...
    public abstract array<java.util.List<Pet>> findPetsByTags(Http.Request request, @NotNull java.util.List<String> tags) ;

...
public:
    ...
    void exampleSomeMethodGetRequest();
    

    void exampleSomeMethodGetResponse(const OAIExampleResponse& res);
    

    void exampleSomeMethodGetError(const OAIExampleResponse& res, QNetworkReply::NetworkError error_type, QString& error_str);

...
public:
    ...
    void retrieveSomethingResponse(const QList<double>& res);
    

    void retrieveSomethingError(const QList<double>& res, QNetworkReply::NetworkError error_type, QString& error_str);

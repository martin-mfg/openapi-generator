...
void OAIDefaultApiRequest::retrieveSomethingResponse(const QList<double>& res){
...
void OAIDefaultApiRequest::retrieveSomethingError(const QList<double>& res, QNetworkReply::NetworkError error_type, QString& error_str){

...
void OAIDefaultApiRequest::exampleSomeMethodGetRequest(){
    qDebug() << "/example/someMethod";
    connect(this, &OAIDefaultApiRequest::exampleSomeMethodGet, handler.data(), &OAIDefaultApiHandler::exampleSomeMethodGet);

    


    emit exampleSomeMethodGet();
}



void OAIDefaultApiRequest::exampleSomeMethodGetResponse(const OAIExampleResponse& res){
...
void OAIDefaultApiRequest::exampleSomeMethodGetError(const OAIExampleResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){

...
bool ExampleResponse::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<double>& value = m_MyOnlyProperty;
...
std::vector<double> ExampleResponse::getMyOnlyProperty() const
{
    return m_MyOnlyProperty;
}
void ExampleResponse::setMyOnlyProperty(std::vector<double> const value)
{

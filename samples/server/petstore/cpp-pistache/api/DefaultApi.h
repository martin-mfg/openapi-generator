...
private:
    ...
    void dummy_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    /// dummy
    /// </remarks>
    virtual void dummy(Pistache::Http::ResponseWriter &response) = 0;

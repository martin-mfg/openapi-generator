...
private:
    ...
    void example_some_method_get_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    /// 
    /// </remarks>
    virtual void example_some_method_get(Pistache::Http::ResponseWriter &response) = 0;

...
void DefaultApi::setupRoutes() {
    ...
    Routes::Get(*router, base + "/example/someMethod", Routes::bind(&DefaultApi::dummy_handler, this));
...
void DefaultApi::dummy_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
    try {

...
void DefaultApi::setupRoutes() {
    ...
    Routes::Get(*router, base + "/example/someMethod", Routes::bind(&DefaultApi::example_some_method_get_handler, this));
...
void DefaultApi::example_some_method_get_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
    try {


    try {
        this->example_some_method_get(response);

...
void DefaultApi::setupRoutes() {
    ...
    Routes::Get(*router, base + "/example/someMethod", Routes::bind(&DefaultApi::retrieve_something_handler, this));
...
void DefaultApi::retrieve_something_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
    try {


    try {
        this->retrieve_something(response);

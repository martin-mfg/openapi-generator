...
public class PetApi  {
  ...
  @Inject PetApiService delegate;
    ...
    public Response findPetsByStatus( @NotNull @ApiParam(value = "Status values that need to be considered for filter",required=true)  @QueryParam("status") java.util.List<String> status) {
    ...
    public Response findPetsByTags( @NotNull @ApiParam(value = "Tags to filter by",required=true)  @QueryParam("tags") java.util.List<String> tags) {

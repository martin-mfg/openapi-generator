...
type alias ExampleResponse =
    { myOnlyProperty : Maybe ( List Bool )
    }
...
encodeExampleResponsePairs model =
    let
        pairs =
            [ maybeEncode "myOnlyProperty" (Json.Encode.list Json.Encode.bool) model.myOnlyProperty
            ]
    in
    pairs
...
exampleResponseDecoder =
    Json.Decode.succeed ExampleResponse
        |> maybeDecode "myOnlyProperty" (Json.Decode.list Json.Decode.bool) Nothing

...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi3-extensions-x-auth-id-alias-jersey2-java8:dummy"
  }
```
...
- `target/openapi3-extensions-x-auth-id-alias-jersey2-java8-dummy.jar`
- `target/lib/*.jar`

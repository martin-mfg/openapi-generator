...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:petstore-openapi3-jersey2-java8-special-characters:dummy"
  }
```
...
- `target/petstore-openapi3-jersey2-java8-special-characters-dummy.jar`
- `target/lib/*.jar`

...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:petstore-openapi3-jersey2-java8-special-characters:0.0.1"
  }
```
...
- `target/petstore-openapi3-jersey2-java8-special-characters-0.0.1.jar`
- `target/lib/*.jar`

...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:petstore-openapi3-jersey2-java8-special-characters:dumy"
  }
```
...
- `target/petstore-openapi3-jersey2-java8-special-characters-dumy.jar`
- `target/lib/*.jar`

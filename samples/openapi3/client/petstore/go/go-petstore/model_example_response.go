...
func (o *ExampleResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "emptyString")
		delete(additionalProperties, "numberString")
		delete(additionalProperties, "boolString")
		delete(additionalProperties, "nullString")
		delete(additionalProperties, "aBool")

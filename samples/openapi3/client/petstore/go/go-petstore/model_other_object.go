...
func (o *OtherObject) UnmarshalJSON(bytes []byte) (err error) {
	varOtherObject := _OtherObject{}

	if err = json.Unmarshal(bytes, &varOtherObject); err == nil {
		*o = OtherObject(varOtherObject)
	}

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "myOnlyProperty2")
